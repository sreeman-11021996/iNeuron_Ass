...
class MyGridLayout(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        # add widgets
        self.inside.add_widget(Label(text="Name: ", font_size=20))
        # text input
        self.name = TextInput(multiline=False)
        self.inside.add_widget(self.name)

        # add widgets
        self.inside.add_widget(Label(text="Age: ", font_size=20))
        # text input object
        self.age = TextInput(multiline=False)
        self.inside.add_widget(self.age)

        # add widgets
        self.inside.add_widget(Label(text="Education: ", font_size=20))
        # text input object
